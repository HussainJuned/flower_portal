                ...
                <table class="table">
                    ...
                    <?php $__currentLoopData = $upcoming_orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr scope="row">
                            ...
                            <td><?php if($order->productReview): ?>
                                    <?php echo e($order->productReview->quality); ?> / 5
                                <?php else: ?>
                                    n/a
                                <?php endif; ?>
                            </td>
                            <td><a href="<?php echo e(route('seller_dashboard.order.view', ['order' => $order->id])); ?>"
                                   class="btn btn-primary">view</a>
                                <!-- Button trigger modal -->
                                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#ur_<?php echo e($order->id); ?>">
                                    edit
                                </button>
                    ...
                    <?php $__currentLoopData = $past_orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr scope="row">
                            ...
                            <td><a href="<?php echo e(route('seller_dashboard.order.view', ['order' => $order->id])); ?>"
                                   class="btn btn-primary">view</a>
                                <!-- Button trigger modal -->
                                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#po_<?php echo e($order->id); ?>">
                                    edit
                                </button>
