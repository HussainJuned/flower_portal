        ...
        <main>
            <form action="{{ route('products.store') }}" method="post" class="w-50 mx-auto mb-5"
                ...
                <div class="form-group mb-30">
                    ...
                    <div class="input-group">
                        ...
                        <input required type="number"
                               ...
                               value="{{ old('price_per_stem_bunch') }}" min="0.1" step="0.1" max="99999999"
                ...
                <div class="form-group mb-30">
                    ...
                    @endif
                    <label for="">Upload Product Photo</label>
...
@push('footer-js')
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $(".gambar").attr("src", "https://via.placeholder.com/400x300?text=Choose Image");
            var $uploadCrop,
                tempFilename,
                rawImg,
                imageId;
